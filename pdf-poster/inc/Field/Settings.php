...
class Settings
{
	...
	function upgrade_notice()
	{
		...
		if (!pdfp_fs()->can_use_premium_code() && ($page->base == 'pdf-poster_page_fpdf-settings' || $is_posters_page)) {
			?>
			<style>
	...
	function upgrade_notice_admin()
	{
		$page = get_current_screen();
		if (!pdfp_fs()->can_use_premium_code() && $page->base == 'pdf-poster_page_fpdf-settings') {
			?>
			<div class="notdice nodtice-warning">upgsdfsdrade</div>
		<?php
		}
	}
}
